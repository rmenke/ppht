...
int main() {
    ...
    end = ppht::postprocess(segments.begin(), segments.end(), 3, 10);
    ...
    end = ppht::postprocess(segments.begin(), segments.end(), 5, 10);
    ...
    end = ppht::postprocess(segments.begin(), segments.end(), 1, 10);
