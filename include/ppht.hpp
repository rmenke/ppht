...
std::vector<segment> find_segments(
    ...
    postprocessor.gap_limit = channel_radius;
    postprocessor.angle_tolerance = 10;

    segments.erase(postprocessor(segments.begin(), segments.end()),
                   segments.end());
